...
const AllResults = () => {
  ...
  const allTestsComplete = mbtiResults && riasecResults && aptitudeResults && gardnerResults;
            ...
            <CardContent className="space-y-6">
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                <div className={`p-4 rounded-lg ${gardnerResults ? 'bg-green-50' : 'bg-red-50'}`}>
                  ...
                  {!gardnerResults && mbtiResults && riasecResults && aptitudeResults && (
    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-10">
          ...
          <p className="mt-2 text-gray-600">Congratulations on completing all four assessments!</p>
        </div>
