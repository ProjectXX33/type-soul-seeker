          ...
          {!showResults ? (
            ...
            <div className="space-y-6">
              <div className="text-center mb-6">
                <h3 className="text-xl font-bold text-amber-800 mb-2">Aptitude Matrix Results</h3>
                <p className="text-gray-600">
                  Based on how you've plotted your skills, here's a preliminary analysis of your strengths and areas for development.
                </p>
              </div>
